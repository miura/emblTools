...
*/
public class FFTFilter_NoDialog implements  PlugInFilter, Measurements {
...
*/
	/** added for no=dialog version
	 * @param imp
	 * @param fht
	 * @param stackSize
	 */
	public FFTFilter_NoDialog(ImagePlus imp) {
		super();
		this.imp = imp;	
 		stackSize = imp.getStackSize();
		fht  = (FHT)imp.getProperty("FHT");
	...
	public static void setparam(double filterLargeDia, double filterSmallDia, int choiceIndex, double toleranceDia, 
	...
	public static String returnParameterString(){
		String fftargument = 
	...
	public static void setFilterLargeDia(double filterLargeDia) {
		FFTFilter_NoDialog.filterLargeDia = filterLargeDia;
	}
	...
	public static void setFilterSmallDia(double filterSmallDia) {
		FFTFilter_NoDialog.filterSmallDia = filterSmallDia;
	}
	...
	public static void setChoiceIndex(int choiceIndex) {
		FFTFilter_NoDialog.choiceIndex = choiceIndex;
	}
	...
	public static void setToleranceDia(double toleranceDia) {
		FFTFilter_NoDialog.toleranceDia = toleranceDia;
	}
	...
	public static void setDoScalingDia(boolean doScalingDia) {
		FFTFilter_NoDialog.doScalingDia = doScalingDia;
	}
	...
	public static void setSaturateDia(boolean saturateDia) {
		FFTFilter_NoDialog.saturateDia = saturateDia;
	}
	...
	public static void setDisplayFilter(boolean displayFilter) {
		FFTFilter_NoDialog.displayFilter = displayFilter;
	}
	...
	public static void setProcessStack(boolean processStack) {
		FFTFilter_NoDialog.processStack = processStack;
	}
}
